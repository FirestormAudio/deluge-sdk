...
//!   (uncached-mirror resolution, SRAM-staging / SDRAM-direct decisions) and the
//!   FSB-metadata validation ([`elf::validate_fsb_metadata`]) the flash-store
//!   path runs before programming an image.
//!
