...
/* Stack sizes */
PROGRAM_STACK_SIZE = 0x30000;  /* 192 KB — crow's Lua parser/VM runs on the
                                  thread-mode executor stack and is recursion-
                                  heavy (esp. in debug builds). Capped to fit
                                  above the RTT reserve (ends 0x202C0000). */
