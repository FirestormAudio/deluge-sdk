...
//! which streams into the codec through the SDK [`deluge::Audio`] block callback
//! (direct SSI TX+RX, SCUX bypassed). Wren scripts build/patch/modulate the graph
//! at control rate; they never touch engine memory directly.
//!
//! ## Concurrency
